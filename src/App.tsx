...
function App() {
  ...
  return (
    <main className="bg-primary h-screen overflow-hidden">
      <div className="px-4 sm:px-14 md:px-24 lg:px-[72px] xl:px-28 text-black-primary lg:flex lg:flex-row mt-[6%] lg:justify-center lg:items-start relative max-w-7xl mx-auto">
        <button
          aria-label="close"
